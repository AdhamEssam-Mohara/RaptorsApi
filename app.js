...
// app.patch('/user_roles/:id', async (req, res) => {
//     // Implementation
// });
...
// // Entity Type routes
// app.post('/entity_types', async (req, res) => {
//     // Implementation
// });

// app.get('/entity_types', async (req, res) => {
//     // Implementation
// });

// app.get('/entity_types/:id', async (req, res) => {
//     // Implementation
// });

// app.patch('/entity_types/:id', async (req, res) => {
//     // Implementation
// });

// app.delete('/entity_types/:id', async (req, res) => {
//     // Implementation
// });

// // Entity Branding routes
// app.post('/entity_branding', async (req, res) => {
//     // Implementation
// });

// app.get('/entity_branding', async (req, res) => {
//     // Implementation
// });

// app.get('/entity_branding/:id', async (req, res) => {
//     // Implementation
// });

// app.patch('/entity_branding/:id', async (req, res) => {
//     // Implementation
// });

// app.delete('/entity_branding/:id', async (req, res) => {
//     // Implementation
// });
...
// // Assuming you have more routes for reports
